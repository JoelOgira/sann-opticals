...
const ServicesSnippet = () => {
    return (
        <section className="bg-white w-full">
            <div className="grid grid-cols-1 [&>div]:px-4 [&>div>p]:text-center [&>div>p]:max-w-xs sm:grid-cols-2 lg:grid-cols-4 lg:[&>div]:px-12">
                <div className="flex flex-col space-y-3 items-center justify-center py-16 border md:py-28">
                    <h3 className="text-white text-xl p-2 rounded-full bg-brightRed"><BsSunglasses /></h3>
